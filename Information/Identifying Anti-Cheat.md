...
I first examined [QuantumClonerScript](https://github.com/petewar3/SAB-AC-Docs/blob/main/Scripts/In-Game/QuantumClonerScript.lua) which I could infer from the source that it didnt link to any anti-cheat. Then I checked [ToolActivationController](https://github.com/petewar3/SAB-AC-Docs/blob/main/Scripts/In-Game/ToolActivationController.lua) which I couldnt confirm at the time whether it was anti-cheat or not due to the fact that it was obfuscated. Then I checked [LocalScript](https://github.com/petewar3/SAB-AC-Docs/blob/main/Scripts/In-Game/LocalScript.lua) which I also couldnt confirm at the time whether it was anti-cheat or not since it was obfuscated. However due to my past of debugging script injection on executors I could see that executors such as delta make a new LocalScript instance which is also named LocalScript which is also found in getnilinstances. Now from this I could infer that LocalScript from the hidden game files was the anti-cheat due to the fact that it seems to be disguising itself as script injection.
